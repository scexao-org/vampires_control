...
class VAMPIRESBeamsplitter():
    ...
    def __init__(self, name="beamsplitter", conf_file="/etc/vampires-control/conf_beamsplitter.json"):
        self.name = name
        self.beamsplitter_wheel = ConexDevice("beamsplitter_wheel", DEVICE_MAP["beamsplitter_wheel"], keyword="beamsplitter_wheel_angle", unit="deg")
...
class VAMPIRESDifferentialFilter():
    ...
    def __init__(self, name="diffwheel", conf_file="/etc/vampires-control/conf_differential_filter.json"):
        self.name = name
        self.diffwheel = ConexDevice("differential_filter_wheel", DEVICE_MAP["differential_filter_wheel"], keyword="differential_filter_wheel_angle", unit="deg")
        self.conf_file = conf_file
        with open(self.conf_file) as fh:
            self.positions = json.load(fh)
...
focus = ConexDevice("focus_stage", keyword="focus_stage", unit="mm")
